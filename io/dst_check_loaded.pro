...
;
; PURPOSE: 
; This function checks whether Dst index data for the chosen time interval is
; already loaded.
; 
; CATEGORY: 
; Input/Output
...
;-
function dst_check_loaded, date, time=time, long=long, $
	silent=silent
...
if dst_info.nrecs eq 0L then $
	return, !false

;- give 3 hours lee way
if dst_info.sjul gt sjul+3.d/24.d then $
	return, !false

if dst_info.fjul lt fjul-3.d/24.d then $
	return, !false
