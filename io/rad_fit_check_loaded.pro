...
if (*rad_fit_info[data_index]).nrecs eq 0L then $
	return, !false

;- give 2 minutes lee way
if (*rad_fit_info[data_index]).sjul gt sjul+2.d/1440.d then $
	return, !false

if (*rad_fit_info[data_index]).fjul lt fjul-2.d/1440.d then $
	return, !false

if ~strcmp((*rad_fit_info[data_index]).code,strlowcase(radar)) then $
	return, !false
