...
pot_drop = make_array(MAX_RECS, /float)
pot_drop_err = make_array(MAX_RECS, /float)
pot_min = make_array(MAX_RECS, /float)
pot_min_err = make_array(MAX_RECS, /float)
pot_max = make_array(MAX_RECS, /float)
pot_max_err = make_array(MAX_RECS, /float)
...
if ptr_valid(rad_map_data[int_hemi]) then begin
	for i=0L, rad_map_info[int_hemi].nrecs-1L do begin
