...
;
; PURPOSE: 
; This function checks whether data for the chosen All-Sky Imager site and time interval is
; already loaded.
; 
; CATEGORY: 
; Input/Output
; 
; CALLING SEQUENCE:
; Result = ASI_CHECK_LOADED(Date, Site)
;
; INPUTS:
; Date: The date of which to read data. Can be a scalar in YYYYMMDD format or
; a 2-element vector in YYYYMMDD format.
;
; Site: Set this to a 4-letter site code to indicate the All-Sky Imager for which to read
; data.
;
; KEYWORD PARAMETERS:
...
;
; COMMON BLOCKS:
; ASI_DATA_BLK: The common block holding the currently loaded radar data and 
...
;-
function asi_check_loaded, date, site, time=time, long=long, $
	silent=silent
...
if n_params() lt 2 then begin
	prinfo, 'Must give date and site code.'
	return, !false
endif
...
if asi_info.nrecs eq 0L then $
	return, !false

;- give 2 minutes lee way
if asi_info.sjul gt sjul+2.d/1440.d then $
	return, !false

if asi_info.fjul lt fjul-2.d/1440.d then $
	return, !false

if ~strcmp(asi_info.site,strlowcase(site)) then $
	return, !false
