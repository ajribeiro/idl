;+ 
; NAME: 
; ACE_MAG_CHECK_LOADED
;
; PURPOSE: 
; This function checks whether data for ACE MAG and time interval is
; already loaded.
; 
; CATEGORY: 
; Input/Output
; 
; CALLING SEQUENCE:
; Result = ACE_MAG_CHECK_LOADED(Date)
;
; INPUTS:
...
;-
function ace_mag_check_loaded, date, time=time, long=long, $
	silent=silent
...
if ace_mag_info.sjul gt sjul+2.d/1440.d then $
	return, !false

if ace_mag_info.fjul lt fjul-2.d/1440.d then $
	return, !false
