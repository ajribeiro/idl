;+ 
; NAME: 
; RAD_FIT_PLOT_NOISE_PANEL
; 
; PURPOSE: 
; This procedure plots the time series of logarithm of the radar noise in a panel.
; 
; CATEGORY: 
; Graphics
; 
...
;
; NO_TITLE: Set this keyword to use more space in y direction, because the big
; title above the page is not accounted for. The panel position will then be
; calculated using DEFINE_PANEL(XMAPS, YMAP, XMAP, YMAP, /NO_TITLE).
;
; EXAMPLE: 
; 
...
;-
pro rad_fit_plot_noise_panel, xmaps, ymaps, xmap, ymap, $
